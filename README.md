...
This crate is not intended to be used directly. For usage instructions, examples, and documentation, please visit the main [`mirust`](https://github.com/irc-rs/mirust) repository.

## License

Licensed under the [MIT License](./LICENSE.md).  
Copyright © 2025 Joshua Byrnes